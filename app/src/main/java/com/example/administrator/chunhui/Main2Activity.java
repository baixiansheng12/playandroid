...
public class Main2Activity extends AbstractSimpleActivity {
  ...
  //  @BindView(R.id.about_us_toolbar)
   ...
   // @BindView(R.id.aboutContent)
    ...
    private void setSmartRefreshLayout() {
        ...
        mAboutUsRefreshLayout.setReboundInterpolator(new com.example.administrator.chunhui.ElasticOutInterpolator());
